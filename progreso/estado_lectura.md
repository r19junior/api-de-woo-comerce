...
Utiliza este archivo para marcar los documentos que ya has estudiado. Esto te ayudará a llevar un control de tu aprendizaje.

## 📁 01 - Primeros Pasos
- [x] [`docs/01-primeros-pasos/introduccion.md`](../docs/01-primeros-pasos/introduccion.md) - Conceptos básicos.
- [x] [`docs/01-primeros-pasos/instalacion.md`](../docs/01-primeros-pasos/instalacion.md) - Configuración local.

## 📁 02 - Referencia Técnica
- [x] [`docs/02-referencia-tecnica/api-manual.md`](../docs/02-referencia-tecnica/api-manual.md) - Endpoints y parámetros.

## 📁 03 - Recursos Externos
- [x] [`docs/03-recursos-externos/sdk-php-oficial.md`](../docs/03-recursos-externos/sdk-php-oficial.md) - **Guía del SDK de PHP.**
- [x] [`docs/03-recursos-externos/enlaces-oficiales.md`](../docs/03-recursos-externos/enlaces-oficiales.md) - Fuentes oficiales.
- [x] [`docs/03-recursos-externos/sdk-y-librerias.md`](../docs/03-recursos-externos/sdk-y-librerias.md) - Herramientas adicionales.

## 📁 Otros
- [x] [`README.md`](../README.md) - Página de inicio.
...
---
> [!TIP]
> ¡Felicidades! Has completado la lectura de toda la documentación base. Ahora estás listo para empezar con las fases prácticas del **Roadmap**.
